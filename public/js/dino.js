...
function setDinoLose() {
    dino.src = "assets/img/dino/coureur_loose.png";
}

function handleRun(delta, speedScale) {
    if (isJumping) {
        dino.src = `assets/img/dino/coureur_jump.png`;
        return;
    }

    if (currentFrameTime >= FRAME_TIME) {
        dinoFrame = (dinoFrame + 1) % DINO_FRAME_COUNT;
        dino.src = `assets/img/dino/coureur_run${dinoFrame}.png`; /* switch between images to simulate movement */
